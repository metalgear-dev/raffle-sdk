...
exports.collectStruct = new beet.BeetArgsStruct([['instructionDiscriminator', beet.uniformFixedSizeArray(beet.u8, 8)]], 'CollectInstructionArgs');
exports.collectInstructionDiscriminator = [
    208, 47, 194, 155, 17, 98, 82, 236,
];
function createCollectInstruction(accounts, programId = new web3.PublicKey('HhxUeshYUCryZj9qAt43Xy5ws4CM7TMuKr9sSHdAfJtp')) {
    var _a;
